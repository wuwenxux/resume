...
\begin{itemsize}
\item Android related WiFi feature & bug analysis.
...
\begin{itemize}
\item Mainly engaged in the adaptation of 5G modules to different hardware platforms(mips, arm64, x86).
...
\role{C, git, gdb, linux, shell, vscode}{Senior network engineer}
Implement seanet related feature(network protocol stack,  network tools, seanet monitor)
\begin{itemsize}
