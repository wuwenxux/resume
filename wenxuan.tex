...
\begin{itemize}[parsep=0.5ex]
	...
	\item 对网络驱动开发有丰富经验，熟悉开源社区运营规则，并对某些知名项目有过贡献Kernel, DPDK等
	\item 对网络维护和网络性能问题有较深入积累和优化，时延、吞吐等相关优化方案
\end{itemize}

\section{\faUsers\ 工作经历}
\datedsubsection{\textbf{道通智能航空有限公司}, 深圳}{2025年2月 -- 至今 }
\role{高级网络开发工程师} {arm64 c git android ndk cross-plateform }
\begin{onehalfspacing}
国密openssl加密支持
\begin{itemize}
	\item 无人机、遥控器、基站网络，国网特定加密需求（gmssl）调研以及实现。 
	\item 现有无人机组网程序（ChannelManager）逻辑梳理和日志分析
	\item 反馈、定位、分析、解决国网加密需求并根据我们业务提供testcase适配、验证。
\end{itemize}
\end{onehalfspacing}


\datedsubsection{\textbf{鼎桥科技有限公司}, 成都}{2023年7月 --2024年7月 }
\role{网络资深开发工程师} {gdb  c  git  netstack}
\begin{onehalfspacing}
模组终端产品R17维护以及开发
\begin{itemize}
	\item 终端产品在不同硬件(mips, arm, x86)平台下性能问题分析、定位
